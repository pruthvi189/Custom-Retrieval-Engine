...
The first four dimensions encode the category strongly enough that a category
filter is just a nearest-neighbour query.
"""
...
def load_demo(vdb) -> None:
    for meta, cat, emb in DEMO:
        vdb.insert(meta, cat, emb)
